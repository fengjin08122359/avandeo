...
class image_finder_image{
    ...
    function detail_basic($image_id){
		...
		$_base_url = kernel::base_url(1);
		$image_info['url'] = $_base_url.'/'.$image_info['url'];
		$image_info['l_url'] = $_base_url.'/'.$image_info['l_url'];
		$image_info['m_url'] = $_base_url.'/'.$image_info['m_url'];
		$image_info['s_url'] = $_base_url.'/'.$image_info['s_url'];
