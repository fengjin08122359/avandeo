...
EOF;
     ...
     * @return string html内容
     */
    function gimage_swf_remote($view='gimage.html',$app_id='image'){
        ...
        $app_id = $app_id?$app_id:'image';
        $view = $view?$view:'gimage.html';
...
EOF;
    ...
    function img_preview(){
        ...
        if($setting['wm_type']=='text'&&$setting['wm_text']){
            ...
            $tmp_water_file = tempnam(TMP_DIR,'img');
