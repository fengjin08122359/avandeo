...
""==b||/^(?:[a-z\d][a-z\d_.]*@[\w-]+(?:\.[a-z]{2,})+[,;\s]?)+$/i.test(b)}],mobile:[LANG_formplus.validate.mobile,function(a,b){return null===b||""==b||/^0?1[3458]\d{9}$/.test(b)}],tel:[LANG_formplus.validate.tel,function(a,b){return null===b||""==b||/^(0\d{2,3}-?)?[23456789]\d{5,7}(-\d{1,5})?$/.test(b)}],phone:[LANG_formplus.validate.phone,function(a,b){return null===b||""==b||/^0?1[3458]\d{9}$|^(0\d{2,3}-?)?[23456789]\d{5,7}(-\d{1,5})?$/.test(b)}],zip:[LANG_formplus.validate.zip,function(a,b){return null===
