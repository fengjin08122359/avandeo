...
$db['coupons']=array (
  ...
  array (
    ...
    array (
      ...
      'required' => true,
      'default' => '',
      'label' => app::get('b2c')->_('号码'),
      'width' => 110,
      'comment' => app::get('b2c')->_('生成前缀/号码(当全局时为号码)'),
      'editable' => false,
      'in_list' => true,
      'default_in_list' => true,
      'filterdefault'=>true,
    ...
    array (
      ...
      'default' => 1,
      'required' => true,
      'label' => app::get('b2c')->_('领取次数'),
      'width' => 110,
      'comment' => app::get('b2c')->_('每个会员领取的次数'),
      'editable' => false,
      'in_list' => true,
      'default_in_list' => true,
    ),
