...
class b2c_ctl_admin_dingzhi_goods extends desktop_controller{
    ...
    function index(){
        ...
        if($this->has_permission('addgoods')){
            $custom_actions[] = array(
                ...
                'icon'=>'add.gif',
                //'disabled'=>'true',
                'href'=>'index.php?app=b2c&ctl=admin_dingzhi_editor&act=add',
                'target'=>'_blank'
            );
        }
        $custom_actions[] = array(
        ...
        $actions_base['base_filter']['e_type'] ="dingzhi";
    ...
    function import(){
        ...
        $file = 'http://www.designwelt.cn/app/b2c/crontab/21.csv';
        $type = 'shafa';
        kernel::single('b2c_goods_dingzhi')->import_data($file,$type);
        $file = 'http://www.designwelt.cn/app/b2c/crontab/22.csv';
        $type = 'chuang';
        kernel::single('b2c_goods_dingzhi')->import_data($file,$type);
        die;
