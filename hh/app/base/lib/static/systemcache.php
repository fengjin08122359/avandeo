...
class systemcache{
    ...
    function __construct($prefix){
        $this->set_controller(kernel::single('base_systemcache_apc', $prefix));
    ...
    static public function instance($prefix){
        if(!isset(self::$__instance[$prefix])){
            self::$__instance[$prefix] = new systemcache($prefix);
        }
    ...
    {
        if($controller instanceof base_interface_systemcache){
            $this->__controller = $controller;
        }else{
            throw new Exception('this instance must implements base_interface_systemcache');
        }
    }//End Function
