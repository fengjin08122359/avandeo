var Dialog = function(url,obj){
    ...
    var applyElement = function(){
        ...
        if(self.options.type == 'window'){
            self.headEle = $('<div class="dialog-head"></div>');
            self.closeEle = $('<span class="close">X</div>');
            self.headEle.html(self.options.title).appendTo(self.dialogEle);
            self.closeEle.appendTo(self.headEle);
            self.closeEle.bind('click',function(){
                self.close();
            });
        }
