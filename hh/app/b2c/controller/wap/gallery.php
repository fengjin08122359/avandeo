...
class b2c_ctl_wap_gallery extends wap_frontpage{
    ...
    public function index($cat_id='',$urlFilter=null,$orderBy=0,$page=1,$virtual_cat_id=null,$showtype=null) {
        ...
        error_log(print_r($params,1)."========----",3,DATA_DIR."/params.log");
        error_log(print_r($page,1)."----====",3,DATA_DIR."/params.log");
        error_log(print_r($params['orderby'],1)."-------------\n\n",3,DATA_DIR."/params.log");
        ...
        if(isset($tmp_filter['search_keywords'][0])){
            $GLOBALS['runtime']['search_key'] = $tmp_filter['search_keywords'][0];
        }
