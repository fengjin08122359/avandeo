...
class b2c_view_input{
	...
	public function input_corp_code($params)
	{
		...
		$str_return .= '</select>&nbsp;<input type="radio" id="b2c-admin-corp-other-code" value="1" name="corp_code_other"' . ((!$ckecked && $params['value']) ? ' checked="checked"' : '' ) . ' /><input type="text" name="corp_code_copy" value="' . ((!$ckecked && $params['value']) ? $params['value'] : '' ) . '"' . ((!$ckecked && $params['value']) ? ' vtype="'.$params['vtype'].'"' : '' ) . ' class="x-input" />';
