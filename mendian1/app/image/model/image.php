...
class image_mdl_image extends dbeav_model {
	...
	function rebuild($image_id, $sizes, $watermark = true) {
		...
		if ($sizes) {
			...
			// error_log(''.var_export($cur_image_set, 1)."\r\n", 3, __FILE__ .'.log');
			//error_log(''.var_export($allsize, 1)."\r\n", 3, __FILE__ .'.log');
