...
Object.each(b,function(a,b){f(h,b).module=a}):"string"==typeOf(b)&&(c=a+"_"+b,f(h,b).module=c)}):"string"==typeOf(b)&&(c=c||a+"_"+b,f(h,b).module=c);return this};this.dom=function(a,b,c){var f=b+">"+c;if(this[f])return this[f];this[f]=this.get(b)[a](c);return this[f]};this.element=function(a,b){return this.dom("getElement",a,b)};this.elements=function(a,b){return this.dom("getElements",a,b)};if(a)return this.mod(a,c,b)};
function setGridSize(a,c,b){var b=b||0,d=0,e=a.length;if(0!=e){for(;d<e;d++){var g=a[d],f=g.getPosition().y;if(0<d){var h=a[d-1];g.innerHTML.trim()||g.setStyle("height",h.getStyle("height"));0==b&&(g=h.getPosition().y,f>g&&(b=d))}}0==b&&(b=e);d=a[0].getParent();d=d.getSize().x-d.getPatch().x;d=parseInt(d/b);a.setStyle("width",d-a[0].getPatch().x);d=0;for(e=a.length/b;d<e;d++){var k=a.slice(d*b,b*(d+1));k.length&&c.each(function(a){setEqualHeight(k.invoke("getElement",a))})}}}
...
window.addEvent("domready",function(){fixImageSize($$("img[data-img-zoom]"))});function updateCartInfo(){var a=Memory.get("cart_number"),c=Memory.get("cart_count"),b=Memory.get("cart_total_price");try{(a||0===a)&&$$(".op-cart-number").set("text",a),(c||0===c)&&$$(".op-cart-count").set("text",c),(b||0===b)&&$$(".op-cart-total").set("text",b)}catch(d){}}
(function(){browserStore=null;withBrowserStore=function(a){if(browserStore)return a(browserStore);window.addEvent("domready",function(){(browserStore=new BrowserStore)?a(browserStore):window.addEvent("load",function(){a(browserStore=new BrowserStore)})})}})();var priceControl={spec:{decimals:2,dec_point:".",thousands_sep:"",fonttend_decimal_type:0,fonttend_decimal_remain:2,sign:"\uffe5"},format:function(a,c){var b,d=this.spec.sign||"";if(!(a||0===a)||isNaN(+a))return a;a=parseFloat(a);this.spec.cur_rate&&(a*=this.spec.cur_rate);var a=a.round(this.spec.decimals)+"",e=a.indexOf(".");0>e?(e=a.length,b=""):b=a.substr(e+1);for(;b.length<this.spec.decimals;)b+="0";for(var g=[];0<e;)if(2<e)e-=3,g.unshift(a.substr(e,3));else{g.unshift(a.substr(0,e));break}b||
(this.spec.dec_point="");c&&(d='<span class="price-currency">'+d+"</span>");return d+g.join(this.spec.thousands_sep)+this.spec.dec_point+b},number:function(a){if(!a)return null;isNaN(+a)&&("element"===typeOf(a)&&(a=a.get("INPUT"===a.tagName?"value":"text")),0==a.indexOf(this.spec.sign)&&(a=a.split(this.spec.sign)[1]));return+a},calc:function(a,c,b,d){if(!(c||0===c))return null;if(b){var a=!a||"add"==a?1:-1,e=1,g=1;"array"===typeOf(c)&&(e=c[1],c=c[0]);"array"===typeOf(b)&&(g=b[1],b=b[0]);var f=Math.pow(10,
this.spec.decimals*this.spec.decimals),c=Math.abs(e*f*this.number(c)+a*g*f*this.number(b))/f}else c=this.number(c);d||(c=this.format(c));return c},add:function(a,c,b){return this.calc("add",a,c,b)},diff:function(a,c,b){return this.calc("diff",a,c,b)}};
function bindDatepicker(a){a||(a="input.calendar");var a=$$(a),c=window.Shop?Shop.url.datepicker:"";if(a.length)try{$LAB.script(c+"/datepicker.js").wait(function(){a.each(function(a){var b;try{b=JSON.decode(a.get("data-calendar-options"))}catch(c){}new DatePickers(a,b)})})}catch(b){}}
window.addEvent("domready",function(){bindDatepicker();var a=window.Shop?Shop.url.fav_url:"",c=Memory.get("member"),c=new Memory("gfav."+c,365),b=function(b,c,d){function e(a){a.innerHTML='<span class="fav-on">\u5df2\u6536\u85cf</span> <i>|</i> <a href="javascript:void(0);" class="btn-delete">\u79fb\u9664</a>'}if(c&&!b.hasClass("fav-on")){var j=b.getParent(".p-action");if(d)return e(j);b=b.get("_type")?b.get("_type"):"goods";(new Request({url:a,onRequest:function(){this.FAVHTML=j.innerHTML;j.innerHTML=
'<span class="fav-loading">\u6536\u85cf\u4e2d...</span>'},onSuccess:function(a){(a=JSON.decode(a))&&a.success?(j.innerHTML='<span class="fav-success"><q class="icon">&#x25;</q> \u6536\u85cf\u6210\u529f</span>',e.delay(2E3,this,j)):j.innerHTML=this.FAVHTML}})).post({type:b,gid:c})}},d=function(b,c,d){function e(){b.getParent().getElement("[rev="+b.get("rel")+"]").setStyle("display","").replaces(b)}if(c){if(d)return e();d=b.get("data-type")?b.get("data-type"):"goods";(new Request({url:a,onRequest:function(){this.FAVHTML=
b.innerHTML;b.innerHTML='<span class="fav-loading">\u6536\u85cf\u4e2d...</span>'},onSuccess:function(a){a=JSON.decode(a);a.success&&e()}})).post({type:d,gid:c})}},e=Array.from((c.read()||"").split(","));$$("a[rel=_addfav_]").each(function(a){var c=a.get("data-gid");e.contains(c)&&b(a,c,!0)});$$("[rel=_favbtn_]").each(function(a){var b=a.get("data-gid");e.contains(b)&&d(a,b,!0)});window.Event_Group&&Object.merge(Event_Group,{_addfav_:{fn:function(a){a=$(a.target)||$(a);b(a,a.get("data-gid"));return!1}},
_favbtn_:{fn:function(a){a=$(a.target)||$(a);d(a,a.get("data-gid"));return!1}}})});
