...
class b2c_ctl_admin_order extends desktop_controller{
    ...
    public function index(){
        ...
        $this->finder('b2c_mdl_orders',array(
            ...
            'actions'=>array(
                            array('label'=>app::get('b2c')->_('门店下单'),'href'=>'index.php?app=b2c&ctl=admin_order&act=addnew','target'=>'_blank','icon'=>'sss.ccc'),
                            ...
                            array('label'=>app::get('b2c')->_('打印订单合同'),'submit'=>'index.php?app=b2c&ctl=admin_order&act=toprint','target'=>'_blank'),
    ...
    public function docreate()
    {
        ...
        if ($result)
        {
            $url = 'http://localhost/hh/index.php/openapi/b2c.orders/get_order_info';
            $core_http = kernel::single('base_httpclient');
            $response = $core_http->set_timeout(15)->post($url,$od);
           # error_log(''.var_export(json_decode($response),1)."\r\n",3,__FILE__.'.log');
