...
var $idColumn = 'cpns_id'; //表示id的列
     ...
     */
    function verify_coupons(&$aData=array(),&$msg='') {
        ...
        //foreach ($aData['coupon'] as $couponCode => &$acoupon) {
            ...
            if ($this->useMemberCoupon($coupon, $mlvid ,$msg)) {
                return true;
     ...
     * 前台会员使用优惠券的验证
     */
    function useMemberCoupon($couponCode, $mlvid,&$msg='') {
